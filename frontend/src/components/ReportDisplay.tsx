  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{report.title}</h2>
        ...
        <div className="flex gap-2">
          <button
            onClick={handleCopy}
            className="flex items-center gap-2 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors text-sm dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-100"
          >
            {copied ? (
              <>
      ...
      <div className="prose prose-lg max-w-none">
        <ReactMarkdown
          components={{
            ...
            p: ({ ...props }) => <p className="mb-4 leading-relaxed text-gray-700 dark:text-gray-200" {...props} />,
            ...
            blockquote: ({ ...props }) => (
              <blockquote className="border-l-4 border-primary-500 pl-4 italic my-4 text-gray-600 dark:text-gray-300" {...props} />
            ),
          }}
        >
          {report.content}
